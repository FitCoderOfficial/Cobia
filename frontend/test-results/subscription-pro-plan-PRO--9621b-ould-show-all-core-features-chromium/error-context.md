...
- Name: PRO Plan Subscription >> should show all core features
- Location: /Users/master/Works/Dev/Cobia/frontend/tests/subscription/pro-plan.spec.ts:76:7
...
Locator: getByText('AI 인사이트')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for getByText('AI 인사이트')

    at /Users/master/Works/Dev/Cobia/frontend/tests/subscription/pro-plan.spec.ts:87:30
```
