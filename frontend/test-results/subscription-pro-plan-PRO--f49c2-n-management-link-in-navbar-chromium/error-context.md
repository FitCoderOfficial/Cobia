...
- Name: PRO Plan Subscription >> should show subscription management link in navbar
- Location: /Users/master/Works/Dev/Cobia/frontend/tests/subscription/pro-plan.spec.ts:65:7
...
Call log:
  ...
  - waiting for getByRole('link', { name: /구독 관리/i })
    ...
    at /Users/master/Works/Dev/Cobia/frontend/tests/subscription/pro-plan.spec.ts:73:34
```
